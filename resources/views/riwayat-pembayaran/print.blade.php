...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Desa Karangmulyo, Kecamatan Purwodadi, Kabupaten Purworejo, Jawa Tengah 59431</p>
        </div>
        ...
        <div class="detail">
            ...
            <p class="lunas" style="text-align: center">Periode {{ $pembayaran->pemakaian->periode->periode }} <b> LUNAS
                    !!!</b></p>
        </div>
    </div>
</body>
